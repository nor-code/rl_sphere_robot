...
agent = DeepQLearningAgent(state_dim=4,
                           ...
                           algo='ddqn')
#
agent.q_network.load_state_dict(torch.load('../models/model_4/name2.pt', map_location=torch.device('cpu')))
agent.eval()
...
env = make_env(episode_timeout=50, type_task=-1, trajectory='circle', begin_index_=17)[0]
