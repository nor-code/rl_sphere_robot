...
class TrakingTrajectoryTask8(base.Task):
    ...
    def __init__(self, trajectory_x_y, begin_index, timeout, R=0.242, random=None):
        ...
        self.prev_index3 = self.get_index(begin_index + 2)
        self.prev_index4 = self.get_index(begin_index + 3)
        self.prev_index5 = self.get_index(begin_index + 4)
