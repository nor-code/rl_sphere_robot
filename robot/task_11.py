...
class TrakingTrajectoryTask11(base.Task):
    ...
    def get_nearest_5_points_index(self):
        ...
        self.index1 = self.get_index(arr[0] - 2)
        self.index2 = self.get_index(arr[0] - 1)
        self.index3 = arr[0]
        self.index4 = self.get_index(arr[0] + 1)
        self.index5 = self.get_index(arr[0] + 2)
    ...
    def get_termination(self, physics):
        if len(self.points) == 0 or physics.data.time > self.timeout or self.count_invalid_states >= 3\
