...
nohup python3 main.py --simu_number=4 --type_task=4 --algo=ddqn --trajectory=circle --buffer_size=5000000 --batch_size=8192 --refresh_target=400 --total_steps=300000 --decay_steps=200000 > out4.log &
