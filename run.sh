...
nohup python3 main.py --simu_number=3 --type_task=3 --algo=ddqn --trajectory=circle --buffer_size=2500000 --batch_size=8192 --refresh_target=1000 --total_steps=350000 --decay_steps=200000 > out3.log &
