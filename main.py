...
parser.add_argument('--type_task', type=int, default=12, help='type of task. now available 4, 5')
...
parser.add_argument('--agent_type', type=str, default='ddpg', help='type of agent. available now: dqn, ddqn, ddpg, td3')
